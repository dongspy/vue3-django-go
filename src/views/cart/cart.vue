<template>
  <div id="main">
    ...
    <div class="cart-box" id="cart-box">
      <div class="hd"><span class="no2" id="itemsnum-top">{{goods.goods_list.length}}件书籍</span>
      ...
      <div class="fd cle">
        ...
        <div class="fr" id="price-total">
          <p><span id="selectedCount">{{goods.goods_list.length}}</span>件书籍，总价：<span class="red"><strong
        ...
        <div class="extr">
          ...
          <div class="pay">
            ...
            <p class="payWrap"><img v-for="item in payWrapList"
                                    src="http://vueshopstatic.mtianyan.cn/images%5Calipay.jpg"
