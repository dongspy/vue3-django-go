        ...
        <div class="fr form-box">
          ...
          <ul class="form other-form">
            ...
            <li class="other-login">
              ...
              <a class="sina" href="http://vueshop.mtianyan.cn/login/weibo/"></a>
              <a class="weixin" href="http://vueshop.mtianyan.cn/login/weixin/"></a>
            </li>
          </ul>
          <p class="form-p">
            没有帐号？
...
<style scoped>
  ...
  .bg-box {
    background: url(http://myphoto.mtianyan.cn/blog/180425/gma8Je8L0F.png?imageslim) no-repeat center center;
  }
  ...
  .hd-login {
    ...
    padding-top: 32px;
    padding-left: 190px;
    /*  background:url(http://vueshopstatic.mtianyan.cn/images%5Clogin/logo.png) no-repeat 0 center;*/
  }
  ...
  .index-font {
    ...
    padding-left: 20px;
    color: #fff;
    /*background:url(http://vueshopstatic.mtianyan.cn/images%5Clogin/homepage.png) no-repeat 0 top;*/
  }
