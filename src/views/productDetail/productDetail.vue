                            ...
                            <ul class="sku">
                                <li class="skunum_li cle">
                                    ...
                                    <div class="skunum" id="skunum">
                                        ...
                                        <cite class="storage">(<font id="shows_number">库存: {{proDetail.goods_num}}件</font>)</cite>

                                    </div>
                                </li>
                                <li class="add_cart_li">
                                    <a  v-if="hasSale" class="btn" disabled="disabled" style="pointer-events: none;" >
                                        <i class="iconfont">&#xe600;</i>
                                      已售罄
                                        </a>
                                  ...
                                  <a v-else class="btn" @click="addCollect">
...
import { getGoodsDetail, getFav, addFav, delFav, addShopCart,getShopCarts } from '../../api/api';
  export default {
    data () {
        return {
            productId: '', //当前商品id
        ...
        getDetails () { //  请求商品详情
          getGoodsDetail(this.productId)
            .then((response)=> {
                ...
                // this.curShow = this.proDetail.goods_front_image;
