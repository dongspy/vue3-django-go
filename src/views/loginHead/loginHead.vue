<template>
    ...
    <div id="header">
        ...
        <div class="hd_bar" id="userinfo-bar">
            <div class="bd">
                <div class="logo">
                    <router-link :to="'/app/home/index'" >袋鼠二手书网</router-link>
                </div>
...
#header .logo a {
    ...
    padding-top:68px;
    overflow:hidden;
    background:#A7B9C3 url(http://myphoto.mtianyan.cn/blog/180426/K8Chgf90bk.png?imageslim) center 0 no-repeat
}
.hd_bar .bd {
    padding-left:182px;
    width:826px;
