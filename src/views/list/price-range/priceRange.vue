                ...
                <div class="priceform" id="priceform" v-clickoutside="handleClickOutside">
                    <div class="form-bg">
                        <form id="freepriceform" >
                            <span class="rmb"></span>
                            <input type="text" name="price_min" id="pricemin" v-model="price_min" @focus="focus=true">
                            <span class="rmb rmb2"></span>
                            <input type="text" name="price_max" id="pricemax" v-model="price_max" @focus="focus=true">
...
.search-options dd .items a:hover{color:#e84540}
...
.search-options dd a.more-btn{position:absolute;top:3px;right:5px;margin-right:0;padding:0 20px 0 0;background-position:30px -381px;display:none;color:#A7B9C3}
...
.sort .curr .search_DESC{border:1px solid #fff;padding:4px 26px 4px 15px;background-position:right -104px;+background-position:right -102px;color:#A7B9C3;text-shadow:1px 1px 1px #fff}
.sort .curr .search_ASC{border:1px solid #fff;padding:4px 26px 4px 15px;background-position:right -330px;+background-position:right -328px;color:#A7B9C3;text-shadow:1px 1px 1px #fff}
