                ...
                <form id="mobile_register_form" autocomplete="off">
                    ...
                    <div class="clearfix">
                        <div class="form-group marb8 verify-code">
                            <label>短信验证码</label>
                            <input id="jsPhoneRegCaptcha" v-model="code" type="text" placeholder="输入手机验证码" @focus="clearError">
                        </div>
...
.hd-login{
    ...
    padding-top:32px;
    padding-left:190px;
   /* background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/logo.png) no-repeat 0 center;*/
}
.index-logo{
    position:absolute;
    left:0;
...
.index-font{
    ...
    padding-left:20px;
    color:#fff;
  /*  background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/homepage.png) no-repeat 0 top;*/
}
